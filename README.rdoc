...
This was originally buit in Ruby on Sinatra (https://github.com/Thomas-C-Voegeli/mandarin-ebook), and I'm now in the process of porting it to Rails. This Rails version includes some improvements to the structure of the database to allow for future feature additions.
